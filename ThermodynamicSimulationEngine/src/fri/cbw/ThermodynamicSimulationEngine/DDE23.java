...
//      consider adding some progress observer
...
public class DDE23 {
    ...
    public static class IntegrationResult {
         ...
         *
         * % DDE23 provides the independent variable x = sol.x as an % ordered
         * row vector and y = sol.y as y(:,k) = y(x(k)). The % cubic Hermite
     ...
     * @return
     */
    public static IntegrationResult integrate(FirstOrderDelayDifferentialEquations ddes, double[] lags, double[] history, double t0, double tfinal) {
